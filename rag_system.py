...
def main():
    ...
    try:
        # Initialize the RAG system
        rag = RAGSystem(
            faiss_index_path="/Users/thamer-gahtani/Documents/Iron_hack_project/faiss_index.idx",
            vectors_path="/Users/thamer-gahtani/Documents/Iron_hack_project/vectors.pkl"
        )
